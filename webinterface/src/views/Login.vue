        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="login-panel text-left">
                    ...
                    <div id="usercontener">
                        <br><br><br>
                        <h1 class="display=3 font-weight-bold">User Informations </h1>
                        ...
                        <br>
                            <div class="form-group">
                                ...
                                <input type="txt" v-model="passwordInput" class="form-control" placeholder="password">
                            </div>
                        <br>
                            <div class="form-group d-flex justify-content-center">
                                <button class="btn btn-primary w-25" type="submit" @click="appel(emailInput,passwordInput)">Envoyer</button>
                            </div>
                        <br>
                            <div class="form-group d-flex justify-content-center">
                                <button class="btn btn-primary w-25" type="submit" @click="postUser(emailInput,passwordInput)">Créer</button>
                            </div>
                      </div>
                    <br>
                        ...
                        <div id="modfify" >
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"> Check it ! Two options : Delete or put your new informations  </h5> 
                                    <!-- <label> Username : <input type="text" v-model="user.username" /> </label> 
                                    <label> Email : <input type="text" v-model="user.email" /> </label>                              -->
                                    <p class="card-text"> Username : {{ user.password }} </p>
...
data() {
    ...
    // gabi1n@gabin.com
    methods: {
        async appel(emailInput,passwordInput) {
